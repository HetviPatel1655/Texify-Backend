...
export class PurchaseOrdersService {
  ...
  async getById(id: string, tenantId: string): Promise<PurchaseOrderDto | null> {
  ...
  async create(dto: CreatePurchaseOrderDto, context: CrudContext): Promise<{ data: PurchaseOrderDto }> {
  ...
  async update(id: string, dto: UpdatePurchaseOrderDto, context: CrudContext): Promise<{ data: PurchaseOrderDto }> {
